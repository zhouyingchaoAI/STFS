...
from db_utils import read_line_hourly_flow_history, insert_hourly_prediction_to_db, fetch_holiday_features
...
def predict_and_plot_timeseries_flow(
    ...
    try:
        if mode in ['all', 'train']:
            ...
            # df = read_line_hourly_flow_history()
            df = read_line_hourly_flow_history(predict_date, 15)
